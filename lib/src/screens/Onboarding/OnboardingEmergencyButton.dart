...
class OnboardingEmergencyButton extends StatelessWidget {
  @override
      ...
      body: SingleChildScrollView(
        child: Column(
          ...
          children: [
                  ...
                  child: TextButton(
                    onPressed: () {
                      Navigator.pushReplacement(
                        context,
                        MaterialPageRoute(
                            builder: (context) => OnboardingWelcomeScreen()),
                      );
                    },
                    child: const Row(
                      children: [
            ...
            const BemVinda(
              svgPath: 'assets/onboarding_emergency_button.svg',
              size: 200,
            ),
            ...
            const Padding(
              ...
              child: Text(
                ...
                softWrap: true,
                'Envie para seus contatos de emergência sua localização sempre que se sentir insegura',
                textAlign: TextAlign.center,
                style: TextStyle(
                  fontSize: 20,
            ...
            TextButton(
              onPressed: () {
                Navigator.pushReplacement(
                  context,
                  MaterialPageRoute(builder: (context) => OnboardingMap()),
                );
              },
