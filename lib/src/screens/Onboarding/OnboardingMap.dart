...
class OnboardingMap extends StatelessWidget {
  @override
      ...
      body: SingleChildScrollView(
        child: Column(
          ...
          children: [
            ...
            const BemVinda(
              svgPath: 'assets/onboarding_map.svg',
              size: 200,
            ),
            ...
            const Padding(
              ...
              child: Text(
                ...
                softWrap: true,
                'Obtenha mais informações sobre a segurança de diversos pontos da UFRPE e seus arredores',
            ...
            TextButton(
              onPressed: () {
                Navigator.pushReplacement(
                  context,
                  MaterialPageRoute(builder: (context) => OnboardingForum()),
                );
              },
